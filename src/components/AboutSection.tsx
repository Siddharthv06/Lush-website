    ...
    <section id="about" className="py-28 bg-[#FAF9F6] text-brand-dark relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start pb-16 border-b border-slate-200"
        >
          {/* Left Column */}
          ...
          {/* Right Column */}
          <div className="lg:col-span-6 space-y-4 text-slate-600 text-base leading-relaxed">
            <span className="text-xs font-bold text-brand-forest uppercase tracking-widest block">
              Sourcing & Compliance
            </span>
            <p>

...
const GradientWaves: React.FC<GradientWavesProps> = ({
  ...
  useEffect(() => {
    ...
    const onPointerMove = (e: MouseEvent | PointerEvent) => {
      targetMouse[0] = (e.clientX - cachedRect.left) / cachedRect.width;
      targetMouse[1] = 1.0 - (e.clientY - cachedRect.top) / cachedRect.height;
    };
